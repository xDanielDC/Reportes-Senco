...
<body>
    <div class="wrapper">
        <div class="hero">
            ...
            <h1>Informe de visita técnica #{{ $visita->ID ?? 'N/A' }}</h1>
        </div>
        <div class="card">
            <p>Hola <b>{{ $visita->rutaTecnica->NombreCliente ?? '—' }}</b>, adjuntamos el informe técnico generado al finalizar la visita.</p>
            <table class="meta">
                <tr>
