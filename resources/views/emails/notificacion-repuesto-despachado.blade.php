...
<head>
    ...
    <title>Repuesto despachado</title>
    <style>
...
<body>
    <div class="wrapper">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="hero-content" valign="top">
                        ...
                        <h1 class="hero-title">Repuesto despachado - Visita <span class="visit-num">#{{ $visita->ID ?? 'N/A' }}</span></h1>
                    </td>
        ...
        <div class="card">
            <p class="greeting">
                Hola <strong>{{ $destinatario->name ?? 'Usuario' }}</strong>.<br> Uno o más repuestos de esta visita pasaron a estado despachado. Revisa el detalle para continuar con la gestión correspondiente.
            </p>
            ...
            <h2 class="section-heading">Repuestos despachados</h2>
            ...
            @php
                $mostrarBoton = !empty($url)
                    && !empty($tecnico?->email)
                    && strtolower(trim($destinatario?->email ?? '')) === strtolower(trim($tecnico->email));
            @endphp
