...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            <p class="greeting">
                Hola <strong>{{ $asistente->name ?? 'AsistenteVentas' }}</strong>.<br> se ha solicitado un repuesto y ahora está pendiente de gestión. Accede al registro directamente desde el botón para revisar los detalles.
            </p>
            ...
            <div class="cta-block">
                <a href="{{ $url }}" class="cta-button">GESTIONAR REPUESTOS EN SS360 →</a>
            </div>
        </div>
