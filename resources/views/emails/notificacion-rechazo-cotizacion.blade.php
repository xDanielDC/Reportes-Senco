...
<body>
    <div class="wrapper">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="hero-content" valign="top">
                        ...
                        <h1 class="hero-title">Cotización rechazada - Visita <span class="visit-num">#{{ $visita->ID ?? 'N/A' }}</span></h1>
                    </td>
        ...
        <div class="card">
            <p class="greeting">
                Hola <strong>{{ $tecnico->name ?? 'Técnico' }}</strong>.<br> La cotización del repuesto ha sido rechazada.
            </p>
            ...
            <h2 class="section-heading">Repuestos rechazados</h2>
